...
async function runPreview(projectRoot) {
  ...
  throw new Error('preview entry exists and build:npm has passed, but preview automation remains intentionally gated in this repository. Build-ready does not mean preview automation is open.');
}
